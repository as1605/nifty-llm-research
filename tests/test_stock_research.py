...
async def test_analyze_stock(mock_stock_data, mock_news_data):
    """Test stock analysis."""
    with patch('src.agents.stock_research.StockResearchAgent._get_stock_data') as mock_get_stock:
        with patch('src.agents.stock_research.StockResearchAgent._get_news_data') as mock_get_news:
            # Setup mocks
